                ...
                <div className='mt-10 md:mt-20 mb-14'>
                    <div className='relative h-full flex-center'>
                        <div className='overflow-hidden'>
                            <img src={frameImg} alt="frame" className='relative z-20 bg-transparent' />
                    ...
                    <div className='flex flex-col justify-center flex-1'>
                        <p className='hiw-text g_fadeIn'>A17 Pro is an entirely new class of iPhone chip that delivers our {""}
                            <span className='text-white'>
                                best graphic performance by far</span>. </p>
                    
                    <p className='hiw-text g_fadeIn'>Mobile {""}
                        <span className='text-white'>
                            games will look and feel so immersive</span>
                        with incredibly detailed environments and characters </p>
                        </div>
