...
const VideoCarousel = () => {
  ...
  const [video, setVideo] = useState({
    isEnd: false,              //El video terminó?
    startPlay: false,          //El video ha comenzado a reproducirse?
    videoId: 0,                //ID de video actual
    isLastVideo: false,        //Es el ultimo video?
    isPlaying: false,          //El video se esta reproduciendo?
  });

  //Guardo los metadatas el video en un estado
